...
$use_get = false;					// Set get vars for server enabled, if this is true you can ignore many config items (not done now) (NOT RECOMMED!!!)
$serveradress = "";					// Minecraftserveradress | IP or Hostname
...
$is_mod = false; 					// set this to true, if you use an mod server like Tekkit, FTB etc
